...
7. Удаление Property каскадно удаляет все его юниты (FK `ON DELETE CASCADE`
   вместе с `dependent: :destroy`). Удаление организации каскадно удаляет все её
...
*Все открытые вопросы закрыты в процессе Spec-сессии. Зафиксированные
решения ниже — источник истины для Plan и Implement.*
