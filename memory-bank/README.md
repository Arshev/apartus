...
- [`flows/README.md`](flows/README.md) — lifecycle feature-документов, state schema, templates, priming prompts. Читать при создании feature package, ADR или запуске lifecycle-шага.
