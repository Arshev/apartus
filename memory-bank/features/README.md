...
| [FT-023-gantt-idle-gaps-mode](FT-023-gantt-idle-gaps-mode/feature.md) | active | in_progress | Gantt Idle Gaps Mode — toolbar toggle отрисовывает hatched pattern окон простоя между бронированиями per unit. Третий FT-020 NS-02 special mode |
