...
| [FT-035-reservation-form-redesign](FT-035-reservation-form-redesign/feature.md) | active | planned | Reservation form redesign — hybrid layout + sticky price breakdown + date range popup + guest quick-create dialog + per-org currency hookup. Closes RUB-hardcoded debt and AI-slop flat form |
