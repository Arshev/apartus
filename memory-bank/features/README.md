...
| [FT-020-gantt-calendar](FT-020-gantt-calendar/feature.md) | active | in_progress | Gantt Calendar Phase 1 — Core: pixel-based timeline, lanes, tooltip, context menu, today marker, replaces CalendarView |
