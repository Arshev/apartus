...
| [FT-022-gantt-overdue-mode](FT-022-gantt-overdue-mode/feature.md) | active | in_progress | Gantt Overdue Mode — toolbar toggle подсвечивает reservations с просроченным выездом (check_out < today && status=checked_in), pulse-анимация, + {n}д label. Второй FT-020 NS-02 special mode |
