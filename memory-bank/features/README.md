...
| [FT-036-stack-migration](FT-036-stack-migration/feature.md) | active | done | **Epic.** Frontend stack migration Vuetify 4 → PrimeVue 4 + Tailwind CSS 4 + Zod. 8-phase delivery on long-lived branch. 0 Vuetify refs, 0 MDI icons, 835 tests green, 95.23% coverage. Pending final merge review |
