...
| [FT-021-gantt-handover-mode](FT-021-gantt-handover-mode/feature.md) | active | not_started | Gantt Handover Mode — toolbar toggle подсвечивает предстоящие заезды/выезды (±1 day bracket), dimmed остальные. Первый из отложенных FT-020 NS-02 special modes |
