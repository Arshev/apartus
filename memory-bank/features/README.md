...
| [FT-036-stack-migration](FT-036-stack-migration/feature.md) | active | planned | **Epic.** Frontend stack migration Vuetify 4 → PrimeVue 4 + Tailwind CSS 4 + Zod. 8-phase delivery on long-lived branch. AI-friendlier stack, explicit schema validation, utility-class styling |
