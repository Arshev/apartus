...
| [FT-033-density-toggle](FT-033-density-toggle/feature.md) | active | done | Gantt row density toggle — comfortable (36/28) ↔ compact (28/22) px. Toolbar icon + `D` shortcut + localStorage persist. Closes re-critique P2 «empty grid expensive» |
