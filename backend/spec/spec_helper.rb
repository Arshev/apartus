...
# otherwise file-level `require`s are not counted in the coverage metric.
# spec_helper.rb is loaded by .rspec via --require, before rails_helper.
require "simplecov"
