...
1. Прочитай [`memory-bank/adr/README.md`](../memory-bank/adr/README.md) — реестр. Возьми следующий свободный номер (монотонно, не переиспользуется).
2. Скопируй шаблон из [`memory-bank/flows/templates/adr/ADR-XXX.md`](../memory-bank/flows/templates/adr/ADR-XXX.md) (embedded contract ниже wrapper frontmatter).
...
7. Обнови [`memory-bank/adr/README.md`](../memory-bank/adr/README.md) — добавь строку в таблицу реестра.
