...
4. **Regression test FIRST** — напиши падающий тест, который воспроизводит баг. До любого правки кода. См. [`memory-bank/engineering/testing-policy.md`](../memory-bank/engineering/testing-policy.md) — "Любой bugfix обязан добавить regression test".
